...
class Transformer(nn.Module):
    ...
    def forward(self, src, query_embed, pos_embed, mask=None, label_mask=None):
        ...
        hs = self.decoder(tgt, memory, memory_key_padding_mask=mask,
                          pos=pos_embed, query_pos=query_embed, label_mask=label_mask) # Pass label_mask to decoder
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,
                ...
                label_mask: Optional[Tensor] = None): # Accept label_mask
        ...
        for layer in self.layers:
            output = layer(output, memory, tgt_mask=tgt_mask,
                           ...
                           pos=pos, query_pos=query_pos, label_mask=label_mask) # Pass to layer
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward_post(self, tgt, memory,
        ...
        if not self.omit_selfattn:
            tgt2, sim_mat_1 = self.self_attn(q, k, value=tgt, attn_mask=label_mask,
    ...
    def forward(self, tgt, memory,
        ...
        if self.normalize_before:
            return self.forward_pre(tgt, memory, tgt_mask, memory_mask,
                                    tgt_key_padding_mask, memory_key_padding_mask, pos, query_pos, label_mask)

...
def get_args():
    ...
    parser.add_argument('--data_dir', help='dir of all datasets', default='/home/lthpc/student/zby_weather/Multi-label-exp/MLC-base/data')
    ...
    parser.add_argument('--kill_stop', action='store_true', help='Enable kill stop feature')
    ...
    args.output = os.path.join(args.output, args.data_name, f'{args.logits_attention}_{args.model_name}_{args.backbone}_{args.pretrain_type}_{args.image_size}_{args.optim}_{args.lr}_{args.weight_decay}_{args.gamma_neg}_{args.clip}_{args.batch_size}_{args.epochs}_seed_{args.seed}')
...
def train(train_loader, model, ema_m, optimizer, scheduler, epoch, args, logger, criterion):
    ...
    for i, (inputs, targets) in enumerate(train_loader):
        ...
        targets = targets.cuda(non_blocking=True) # 确保 targets 也在 GPU 上
